...
public:
	...
	// existing methods for rendering the various objects in the 3D scene
	void RenderTable();
	void RenderBackdrop();
	...
	// new methods for rendering the beer glass and lemon slices
	void RenderBeerGlass();
	void RenderBeerBottle();
	void RenderPlate();
	void RenderLemon();
	void RenderKnife();
};
