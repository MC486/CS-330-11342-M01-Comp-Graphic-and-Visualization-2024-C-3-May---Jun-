...
int main(int argc, char* argv[])
{
	...
	// ESC key to close the window and exit the application
	std::cout << "ESC - close the window and exit\n";

	// W key to zoom in, S key to zoom out
	std::cout << "W - move forward\t" << "S - move backward\n";

	// A key to pan left, D key to pan right
	std::cout << "A - move left\t" << "D - move right\n";

	// Q key to move the camera up, E key to move the camera down
	std::cout << "Q - move up\t" << "E - move down\n";

	// O key to switch to the orthographic view
	std::cout << "O - orthographic view\n";

	// P key to switch to the perspective view
	std::cout << "P - perspective view\n";

	// Mouse movement to look around (change camera orientation)
	std::cout << "Mouse Movement - look around\n";

	// Mouse scroll wheel to adjust the movement speed of the camera
	std::cout << "Mouse Scroll - adjust movement speed\n";
